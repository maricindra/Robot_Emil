...
return (
    ...
    {/* box Container to Left page*/}
        ...
        <p className='text-green-300 sm:text-lg tracking-wider max-w-[25rem] lg:max-w-[30rem]'>
        ...
        {/* 3D Robot*/}
        <Spline className='absolute lg:top-0 top-[-20%] bottom-0 lg:left-[25%] sm:lefet [-2%] h-full' scene="https://prod.spline.design/jR6ieRY7A0x3IIv7/scene.splinecode" />
    <br></br> </main>
